# Graph-tensor Game Optimization driven-Instance Dense-subgraph Disentangled Clustering for Tumor Invariant-topology Learning
...
- [2025/12/15] Our manuscript was submitted to _IEEE Transactions on Medical Imaging_ (IF 9.8).
